...
import com.example.luistovar.archapp.testutils.CoroutineDispatcherProviderTest
...
class ListViewModelTest : BaseTest() {
    ...
    fun setupListViewModel() {
        ...
        listViewModel = ListViewModel(peopleListSwUseCase, CoroutineDispatcherProviderTest())
    }
